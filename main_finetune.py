...
import util.lr_decay_swin2 as lrdSwin2
...
def main(args):
    ...
    if global_rank == 0 and args.log_dir is not None and not args.eval:
        ...
        log_writer = SummaryWriter(log_dir=args.log_dir+f"/{args.task}_Logs/")
    else:
        log_writer = None
    ...
    if args.model == 'swinv2_largeDROPPATH' or args.model == 'swinv2_largeNODECAY' or args.model == 'swinv2_large_window7NEWDECAY':
        model = timm.create_model('swinv2_large_window12to24_192to384.ms_in22k_ft_in1k',
                                  pretrained=True, img_size=args.input_size,
                                  drop_path_rate=args.drop_path,
                                  window_size=7, num_classes=args.nb_classes)
    ...
    # 384 - 12, 24
    # 512 - 16
    if args.model == 'swin_large_patch4_window7_224' or args.model == 'swin_large_patch4_window7_224NEWDECAY':
        model = timm.create_model('swin_large_patch4_window7_224.ms_in22k',
                                  pretrained=True, img_size=args.input_size,
                                  drop_path_rate=args.drop_path,
                                  window_size=7, num_classes=args.nb_classes)

    if args.model == 'swinv2_base_window8_256' or args.model == 'swinv2_base_window8_256NEWDECAY':
        model = timm.create_model('swinv2_base_window8_256.ms_in1k',
                                  pretrained=True, img_size=args.input_size,
                                  drop_path_rate=args.drop_path,
                                  window_size=8, num_classes=args.nb_classes)
    ...
    if args.model == 'resnet50':
        model = timm.create_model(
            ...
            drop_path_rate=args.drop_path,
            num_classes=args.nb_classes)
    if args.model == 'resnet50DROPPATH':
    ...
    if args.model == 'vit_large_patch16' or args.model == 'swinv2_large' or args.model == 'swinv2_largeDROPPATH' or args.model == 'swin_large_patch4_window7_224' or args.model == 'swinv2_base_window8_256':
    ...
    # NEW DECAY TEST ------------------------
    elif (args.model == 'swinv2_large_window7NEWDECAY' or args.model == 'swin_large_patch4_window7_224NEWDECAY' or args.model == 'swinv2_base_window8_256NEWDECAY'):
        print("new decay test")
        param_groups = lrdSwin2.param_groups_lrd_swin(model_without_ddp, args.weight_decay,
                                                      no_weight_decay_list=model_without_ddp.no_weight_decay(),
                                                      layer_decay=args.layer_decay
                                                      )
