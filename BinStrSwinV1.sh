python -m torch.distributed.launch --nproc_per_node=1 --master_port=48292 main_finetune.py \
    --batch_size 32 \
    --world_size 1 \
    ...
    --dataset stroke \
    --task BinStr224SwinV1 \
    --log_dir ../Results/Full_Stroke_Test/BinStr224SwinV1/ \
